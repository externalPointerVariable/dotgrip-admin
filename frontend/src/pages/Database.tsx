import { Checkbox, Table, Flex, Button, Icon, Input, InputGroup} from '@chakra-ui/react';
  ...
  return (
    <>
      <Flex gap={4} justifyContent={"space-between"}>
        ...
        <Button marginEnd={"auto"} variant={"ghost"} border={"ActiveBorder"} _hover={{ bg: "cyan.600" }}>
      ...
      <Flex gap={4} justifyContent={"space-between"} marginTop={"15px"}>
        <InputGroup startElement={<LuSearch />} marginEnd={"auto"} width={"50%"} _active={{border: "cyan.600"}}>
